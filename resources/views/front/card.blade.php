                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="mb-0 mt-4">{{$cart->qty*$cart->price}} $</p>
                                </td>
                                <td>
                ...
                <div class="row g-4 justify-content-end">
                    ...
                    <div class="col-sm-8 col-md-7 col-lg-6 col-xl-4">
                        <div class="bg-light rounded">
                            ...
                            <a href="{{route('check.out')}}" class="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4 ms-4" type="button">Proceed Checkout</a>
                        </div>
                    </div>
                </div>
            </div>
